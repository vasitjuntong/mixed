...
<div class="row">
	...
	<div class="col-md-3">
		<div class="form-group">
			<label class="control-label" for="po_no">{{ trans('requesition.form_search.po_no') }}</label>
	...
	<div class="col-md-3">
		<div class="form-group">
			<label class="control-label" for="ref_no">{{ trans('requesition.form_search.ref_no') }}</label>
...
<div class="row">
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<a href="/requesitions" class="btn btn-default btn-sm">
